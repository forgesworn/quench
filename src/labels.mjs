...
/**
 * @param {string} streamText newline-delimited stream-json events
 * @param {Array<{ token: string }>} required evidence tokens the answer needs
 * @param {{ ignoreTokens?: Iterable<string> }} [options] tokens to drop, e.g. ones a tool prints in its own metadata
 */
export function labelSession(streamText, required, options = {}) {
